...
ALTER TABLE staging.sector OWNER TO redshift_user;

CREATE TABLE IF NOT EXISTS staging.industry (
    industryid      INTEGER,
    industry_name   VARCHAR(100)
) BACKUP NO DISTSTYLE ALL;
ALTER TABLE staging.industry OWNER TO redshift_user;
...
ALTER TABLE staging.security OWNER TO redshift_user;
...
ALTER TABLE staging.eod_price OWNER TO redshift_user;
...
ALTER TABLE staging.security_data OWNER TO redshift_user;
...
ALTER TABLE staging.market_data OWNER TO redshift_user;
...
CREATE TABLE IF NOT EXISTS olap.market_data (
    ...
    marketcap       DOUBLE PRECISION ENCODE zstd,
...
ALTER TABLE staging.marketview OWNER TO redshift_user;
...
copy staging.security from 's3://oracle-redshift/oltp_uploads/security.csv' iam_role 'arn:aws:iam::349411246714:role/Redshift-S3-Quicksight' region 'ca-central-1' format as csv quote as '"' dateformat 'DD-MON-YY';
copy staging.eod_price from 's3://oracle-redshift/oltp_uploads/eod_price.csv' iam_role 'arn:aws:iam::349411246714:role/Redshift-S3-Quicksight' region 'ca-central-1' format as csv quote as '"' dateformat 'DD-MON-YY';
...
ALTER TABLE olap.market_data_bkp OWNER TO redshift_user;


commit;
analyze olap.market_data;
select count(1) from olap.market_data;
